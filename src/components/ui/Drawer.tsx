...
export default function Drawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div
        className="relative flex h-full w-full flex-col border-l border-[#CFE0F5] bg-[#FFFFFF] shadow-2xl sm:w-auto"
      ...
      >
        <div className="flex items-center justify-between border-b border-[#CFE0F5] px-5 py-4">
          ...
          <button
            onClick={onClose}
            className="rounded-[6px] p-1.5 text-[#6B7F93] hover:bg-[#DCEAFB] hover:text-[#0F2A44]"
          >
            <X size={16} />
          </button>
        </div>
